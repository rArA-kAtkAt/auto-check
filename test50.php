...
<body style="background-color:#f0f0f0">
    ...
    <form action="function.php?test-qna50&c=<?php echo $_GET['t'];?>" method="POST">
    ...
    <br>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q31" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q31a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q31c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q31b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q31d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q32" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q32a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q32c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q32b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q32d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q33" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q33a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q33c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q33b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q33d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q34" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q34a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q34c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q34b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q34d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q35" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q35a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q35c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q35b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q35d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q36" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q36a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q36c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q36b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q36d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q37" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q37a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q37c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q37b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q37d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q38" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q38a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q38c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q38b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q38d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q39" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q39a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q39c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q39b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q39d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q40" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q40a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q40c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q40b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q40d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q41" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q41a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q41c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q41b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q41d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q42" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q42a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q42c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q42b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q42d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q43" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q43a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q43c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q43b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q43d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q44" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q44a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q44c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q44b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q44d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q45" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q45a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q45c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q45b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q45d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q46" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q46a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q46c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q46b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q46d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q47" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q47a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q47c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q47b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q47d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q48" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q48a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q48c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q48b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q48d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q49" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q49a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q49c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q49b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q49d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
        ...
        <div class="h-100 d-flex m-auto pb-2">
            ...
            <textarea name="q50" style="font-size:12px;" cols="60" rows="2" class="form-control" required></textarea>
        </div>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
            <textarea name="q50a" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"  class="mr-3 ml-3">C.</label>
            <textarea name="q50c" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex  mt-5 m-auto">
            <label for="" style="font-size:12px;"  class="mr-3">B.</label>
            <textarea name="q50b" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
            <label for="" style="font-size:12px;"   class="mr-3 ml-3">D.</label>
            <textarea name="q50d" style="font-size:12px;" id="" cols="20" rows="1" class="form-control" required></textarea>
        </div>
        <br>
        <div class="h-100 d-flex mt-5  m-auto">
            <label for="" class="mr-3" style="font-size:12px;">Correct answer</label>
