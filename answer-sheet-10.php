...
<br>
    <div class="container fader m-auto mt-5" style="max-width:20rem;" >
<form action="function.php?as10" method="POST">
...
<a href="print-answer-sheet.php?t=10" target="_blank" type="button" class="btn btn-warning btn-sm text-white"><i class="fas fa-print"></i> Print</a>
</div>
