...
<div class="container mt-4">
    <div class="row mt-4">
        ...
        <h6 class="crt-account-text"><strong>Create an Account</strong></h6><hr>
         ...
         <form action="../function.php?register-student" method="POST">


            <div class="input-group w-100  mt-4">
                <select name="grade_level" class="form-control mr-2 rounded" style="font-size:12px; max-width:200px;" id="" required>
                ...
                <input type="text" name="section" placeholder="Section" class="form-control rounded" style="font-size:12px; max-width:200px;" required>
        </div>

        <div class="input-group w-100 mt-3">
            <label for="" class="mr-2 mt-3" style="font-size:13px;">Username:</label>
            <input type="text" name="username" style="font-size:12px;" placeholder="Input Username" class="form-control rounded mt-2" value="<?php echo $username; ?>" readonly>
        </div>
        <div class="input-group w-100 mt-3">
            <label for="" class="mr-2 mt-1" style="font-size:13px;">First Name:</label>
            <input type="text" name="firstname" pattern="[a-zA-Z]{1,}" style="font-size:12px;" placeholder="Input First Name" class="form-control rounded" required>
        </div>
        <div class="input-group w-100 mt-3">
            <label for="" class="mr-2 mt-1" style="font-size:13px;">Middle Name:</label>
            <input type="text" name="middlename" pattern="[a-zA-Z]{1,}" style="font-size:12px;" placeholder="Input Middle Name" class="form-control rounded">
        </div>
        <div class="input-group w-100 mt-3">
            <label for="" class="mr-2 mt-1" style="font-size:13px;">Last Name:</label>
            <input type="text" name="lastname" pattern="[a-zA-Z]{1,}" style="font-size:12px;" placeholder="Input Last Name" class="form-control rounded" required>
        </div>
        <div class="input-group w-100 mt-3">
            <label for="" class="mr-2 mt-1" style="font-size:13px;">Password:</label>
            <input type="password" name="password" style="font-size:12px;" id="id_password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Input Password" class="form-control rounded" required>
