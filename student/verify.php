...
<div class="h-100 d-flex align-items-center justify-content-center" >
    <div class="container" >
        <div class="card m-auto card-design" style="max-width:20rem !important; height:25rem;">
            ...
            <form action="../function.php?verify-code-student" method="POST">
            <div class="row" style="margin-bottom:-30px;">
                <div class="col-md-9 p-3 m-auto">
                <h6 class="text-center" style="font-size:12px; color:#3366CC;">We sent 8 digit code in the email address you provided!</h6>
          </div>
            </div>
            <div class="row">
                <div class="col-md-9 p-3 m-auto fontuser input-size ">
                <input type="number" name="code" pattern="/^-?\d+\.?\d*$/" style="font-size:14px;" class="form-control" onKeyPress="if(this.value.length==8) return false;" placeholder="8 Digit Code" required/>
            ...
            <div class="row">
                <div class="col-md-9 p-3 m-auto text-center">
                    <button type="submit" class="login-btn" style="width:150px;">Submit</button>
                </div>
            </div>
            </form>
            <div class="row">
