...
<body style="background-color:#f0f0f0">
    ...
    <form action="function.php?edit-test-qna10&i=<?php echo $_GET['i'];?>" method="POST">
...
?>
        ...
        <div class="h-100 d-flex  m-auto pb-2 mb-5 pl-4 pr-4">
        ...
        <div class="h-100 d-flex  m-auto pl-4 pr-4">
        ...
        <br>
        <div class="h-100 d-flex m-auto pb-2 pl-4 pr-4">
        ...
        <div class="h-100 d-flex  mt-5 m-auto pl-4 pr-4">
            <label for="" style="font-size:12px;"  class="mr-3">A.</label>
